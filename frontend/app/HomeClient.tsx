...
export default function HomeClient() {
  ...
  return (
    <>
      <div className="min-h-screen cosmic-root overflow-hidden relative text-foreground">
                ...
                case 'marketplace':
                  return (
                    <Window
                      ...
                      zIndex={getZIndex(name)}
                    >
                      <MarketplaceWindow name={name} onOpenWindow={openWindow} />
                    </Window>
                  );
                case 'atelier-viewer':
                  return (
