            ...
            <RetroSection title="ARTWORK INFO">
              <div className="space-y-3">
                <div className="grid grid-cols-2 gap-3">
                  {/* Cover Image Upload - reduced height */}
                  <div>
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      className={`w-full bg-black/60 text-white/90 text-xs p-2 font-mono border ${descriptionError ? 'border-red-400/50' : 'border-white/10'} focus:outline-none focus:border-white/30 resize-none placeholder:text-white/20`}
                      style={{
                ...
                <div className="flex items-center justify-between py-1 border-b border-white/10">
                  ...
                  <div className="flex items-baseline gap-2">
                    ...
                    <input
                      ...
                      placeholder="0"
                      className={`bg-transparent text-white/90 text-xl font-mono text-right w-32 border-b ${priceError ? 'border-red-400/50' : 'border-transparent'} focus:outline-none focus:border-white/30 placeholder:text-white/20 transition-colors`}
                    />
                  </div>
                </div>
                {priceError && (
